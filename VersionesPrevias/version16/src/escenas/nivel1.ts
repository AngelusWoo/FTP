...
export default class Nivel1 extends Phaser.Scene
{
    ...
    constructor () { super(Constantes.ESCENAS.NIVEL1); }
    ...
    {        
        ...
        (this.width/2, this.height/2, 'VIDAS -', 
        ...
        const puntuacionTxt: Phaser.GameObjects.Text = this.add.text
        (this.width/2, this.height/2-100, 'PUNTUACION +', 
        {fontSize:'32px', color:'#FFFFFF'}).setInteractive();
